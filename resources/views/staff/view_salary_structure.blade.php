                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <select id="deduction_id" name="deduction[0][id]" class="form-control deduction_id">
                                                        ...
                                                        @foreach ( $deductions->where('deleted_at',null) as  $deduction)
                                                            @if ($deduction->name != 'Transportation Deduction')
                                                            <option value="{{ $deduction->id }}" data-value="{{ (!is_null($deduction->amount)) ? $deduction->amount : $deduction->percentage }}" data-type="{{ (!is_null($deduction->amount)) ? 'amount' : 'percentage' }}">{{ $deduction->name}}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </div>
