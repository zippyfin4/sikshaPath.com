...
Route::get('debug-logs', static function () {
...
// Debug route to get mobile value
Route::get('debug-mobile-value', static function () {
    return \App\Models\SystemSetting::where('name', 'mobile')->value('data') ?? '';
});
