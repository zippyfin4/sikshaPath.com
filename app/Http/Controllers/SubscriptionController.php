...
class SubscriptionController extends Controller
{
    ...
    public function payment_success($check_out_session_id, $subscriptionBill_id = null, $package_id = null, $type = null, $subscription_id = null, $isCurrentPlan = null)
    {
        ...
        $this->cache->removSiksaPathCache(config('constants.CACHE.SCHOOL.FEATURES'), $subscriptionBill->school_id);
    ...
    public function update_expiry(Request $request)
    {
        ...
        try {
            ...
            $this->cache->removSiksaPathCache(config('constants.CACHE.SCHOOL.FEATURES'), $request->school_id);
            DB::commit();
    ...
    public function update_current_plan(Request $request)
    {
        ...
        try {
            ...
            $this->cache->removSiksaPathCache(config('constants.CACHE.SCHOOL.FEATURES'), $new_subscription->school_id);
            DB::commit();
            ResponseService::successResponse('Data Updated Successfully');
        } catch (Throwable $e) {
            ResponseService::logErrorResponse($e);
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            $this->cache->removSiksaPathCache(config('constants.CACHE.SCHOOL.SETTINGS'), $subscription->school_id);
            DB::commit();
