...
class ExamController extends Controller
{
    ...
    public function uploadMarks()
    {
        ...
        })->with('class', 'class.shift', 'section', 'medium')->orWhereHas('subject_teachers', function ($q) use ($teacherId) {
    ...
    public function bulkUploadIndex()
    {
        ...
        $classes = $this->classSection->builder()
            ...
            ->with('class', 'class.shift', 'section', 'medium', 'subjects')
            ->get();
    ...
    public function viewMarksShow()
    {
        ...
        foreach ($res as $row) {
            ...
            foreach ($row->class->section as $section) {
                ...
                $classNameWithSection = $row->class->name . ' - ' . ($section->name ?? '') . ' ' . ($row->class->medium->name ?? '') . ' (' . ($row->class->stream->name ?? '') . ') (' . ($row->class->shift->name ?? '') . ')';
