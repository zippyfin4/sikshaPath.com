...
class SchoolRepository extends BaseRepository implements SchoolInterface {
    ...
    public function updatSiksaPathAdmin($array, $image = null) {
        $data = (object)$array;
        ...
        if ($user) {
            ...
            $this->updatSiksaPathdatabase($data, $school, $image_path);
    ...
    public function updatSiksaPathdatabase($user, $school, $image_path)
    {
