...
function showSweetAlertConfirmPopup(url, method, options = {}) {
    let opt = {
        ...
        text: window.trans["You wont be able to revert this"] || "You won't be able to revert this!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: window.trans["Confirm"] || "Confirm",
...
function showDeletePopupModal(url, options = {}) {
    ...
    let opt = {
        ...
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: window.trans["yes_delete"] || "Yes, delete it!",
        cancelButtonText: window.trans['Cancel'] || "Cancel",
        successCallBack: function () {
        },
        errorCallBack: function (response) {
...
function showCancelPopupModal(url, options = {}) {
    ...
    let opt = {
        ...
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: window.trans["yes_cancel"] || "Yes, cancel it!",
        cancelButtonText: window.trans['Cancel'] || "Cancel",
        successCallBack: function () {
        },
        errorCallBack: function (response) {
...
function showRestorePopupModal(url, options = {}) {
    ...
    let opt = {
        ...
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: window.trans['Yes Restore it'] || "Yes, Restore it!",
        cancelButtonText: window.trans['Cancel'] || "Cancel",
        successCallBack: function () {
        },
        errorCallBack: function (response) {
...
function showPermanentlyDeletePopupModal(url, options = {}) {
    ...
    let opt = {
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["You are about to Delete this data"] || "You are about to delete this data permanently!",
        icon: 'error',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: window.trans["Yes Delete Permanently"] || "Yes, Delete Permanently!",
        cancelButtonText: window.trans['Cancel'] || "Cancel",
        successCallBack: function () {
        },
        errorCallBack: function (response) {
