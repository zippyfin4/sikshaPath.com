...
$('#create-form,.create-form,.create-form-without-reset').on('submit', function (e) {
    ...
    if ($(formElement).hasClass('attendance-table') && $('.search-input').val()) {
        Swal.fire({icon: 'error', text: window.trans['Kindly clear the data from the search field'] || 'Kindly clear the data from the search field'});
        return 0;
    }
    var school_prefix = '';
    var school_code = '';
...
$('#edit-form,.edit-form,.edit-form-without-reset,.edit-form-staff-payroll-setting').on('submit', function (e) {
    ...
    if (status) {
        ...
        Swal.fire({icon: 'error', text: window.trans['Duplicate values are not allowed'] || 'Duplicate values are not allowed'});
        submitButtonElement.val(submitButtonText).attr('disabled', false);
    }
...
$(document).on('click', '.change-school-status', function (e) {
    ...
    Swal.fire({
        ...
        text: window.trans["change_school_status"] || "Change school status?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: window.trans["Yes, Change it"] || "Yes, Change it!",
...
$(document).on('click', '.change-package-status', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["change_package_status"] || "Change package status?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.delete-class-timetable', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["Delete Class Timetable"] || "Delete Class Timetable?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.change-addon-status', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["change_addon_status"] || "Change addon status?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.delete-payroll-setting', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["Delete this item"] || "Delete this item?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.cancel-upcoming-plan', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["Cancel This Plan"] || "Cancel This Plan?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.select-plan', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        html: window.trans["Agree to This Subscription"] || "Agree to This Subscription?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.id-card-settings', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        html: window.trans["You wont be able to revert this"] || "You won't be able to revert this!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.start-immediate-plan', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["start_immediate_this_plan"] || "Start immediate this plan?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.add-addon', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure you want to add this add-on"] || "Are you sure you want to add this add-on?",
        text: window.trans["This add-on will be added into your current subscribed package and will expire when your current subscription expires"] || "This add-on will be added into your current subscribed package and will expire when your current subscription expires.",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.discontinue_addon', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["discontinue_upcoming_billing_cycle"] || "Discontinue upcoming billing cycle?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.restore-database', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["restore_this_databse"] || "Restore this database?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
...
$(document).on('click', '.create-backup', function (e) {
    ...
    Swal.fire({
        title: window.trans["Are you sure"] || "Are you sure?",
        text: window.trans["want_to_create_a_backup"] || "Want to create a backup?",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
